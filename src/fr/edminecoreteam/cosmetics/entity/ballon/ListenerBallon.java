...
public class ListenerBallon
{
    
    public static void despawnBallon(Player p) {
        for (Entity stand : Bukkit.getServer().getWorld("hub").getEntitiesByClasses(new Class[] { ArmorStand.class })) {
            if (stand != null && stand.getCustomName().equalsIgnoreCase("ballon_" + p.getName())) {
                stand.remove();
                runAction(p, "false");
            }
        }
    ...
    private static void updateLocBallon(Player p) {
        for (Entity stand : Bukkit.getServer().getWorld("hub").getEntitiesByClasses(new Class[] { ArmorStand.class })) {
            if (stand != null && stand.getCustomName().equalsIgnoreCase("ballon_" + p.getName())) {
    ...
    public static void runAction(Player player, String s) {
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (Entity stand : Bukkit.getServer().getWorld("hub").getEntitiesByClasses(new Class[] { ArmorStand.class })) {
                    if (stand != null && stand.getCustomName().equalsIgnoreCase("ballon_" + player.getName())) {
                    	updateLocBallon(player);
                    }
                }
                if (!player.isOnline()) {
                    cancel();
